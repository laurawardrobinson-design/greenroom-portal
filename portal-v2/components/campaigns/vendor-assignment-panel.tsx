...
const PHASE_STYLE: Record<Phase, { color: string; backgroundColor: string; borderColor: string }> = {
  estimate: {
  ...
  invoice: {
    ...
    backgroundColor: "var(--status-submitted-tint)",
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {(cv.estimateTotal > 0 || cv.paymentAmount > 0) && (
                        <div className="mt-2 flex gap-4 text-xs">
                          ...
                          {cv.paymentAmount > 0 && (
                            <span className="text-text-tertiary">
                              Paid: <span className="font-medium text-success">{formatCurrency(cv.paymentAmount)}</span>
                            </span>
                          )}
                        </div>
                      )}
