...
import { MOTH_TRIGGER_WORDS } from "@/lib/constants/menagerie";
...
const triggerPattern = new RegExp(
  `\\b(${MOTH_TRIGGER_WORDS.map((w) => w.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")).join("|")})\\b`,
  "i"
);

export function MothDetector() {
  ...
  const alreadyFound = isDiscovered("moth");
